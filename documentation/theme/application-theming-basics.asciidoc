...
The application can be themed using pure CSS, but to be able to theme Polymer web components,
...
The recommendation is that the file contains all of the application's global and view-specific theming.
...
This is because of the ease of development when you have only one HTML file when creating the HTML and CSS.
...
since the styling is already coupled to the component HTML and you don't have to look for it elsewhere.
